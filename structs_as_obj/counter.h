// Add include guards using COUNTER_H
#ifndef COUNTER_H
#define COUNTER_H
// Define the Counter struct with a single int value member
typedef struct {
    int value;
} Counter;
// Declare counter_increment function
// Takes a pointer to Counter and increases its value by 1
void counter_increment(Counter* counter);
// Declare counter_get function
